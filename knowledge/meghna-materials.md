# Meghna — materials pack (Quantic video part)

Everything for the **3-minute cafe demo** (Home → Gallery → Menu → Reservations).

**Owner rules:** spoken / VO = plain English only. FR/NFR IDs live in supporting notes + Coverage.
...
## 6. Still open (not Meghna-blocking)

- Hiren Architecture vs Coding pick
- Final Quantic submit video = live must-film + voice (dry-run / silent prototype ≠ submit)
- Knowledge #89 Pages land for published Meghna page

---

*Packed 2026-09-05 Europe/Berlin.*
