...
**In plain English:** This is a placeholder for a Sunday recording / presentation window. Notes are **Unknown** until someone writes them. Do not guess a run-of-show.

**When:** Sunday **2026-09-06** — Europe/Berlin date. Clock and room are **Unknown** until the owner fills them. If a US slot is later scheduled, write it as America/New_York **and** Europe/Berlin.
