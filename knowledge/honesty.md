...
| Restaurant MVP in-repo | **On `main`** (PRs #9 + timezone #12). React + JSX, Flask, PostgreSQL. Local path: Vite `127.0.0.1:5173`, Flask `:5000`, `cafe-pg`. App this session (cts-ai, DB up): Journey **J1–J8 PASS**; **J9 Unknown**. This Knowledge VM did not reach Vite. After the handoff, App reported `cafe-pg` unreachable. |
...
| NFR-7 (Chrome, Firefox, Safari, Edge) | **Unknown** — no browser matrix in the App handoff this session. Same #40. |
| Journey 1–9 pass/fail | **J1–J8 PASS** (cts-ai local UX, DB up). **J9 Unknown** (no viewport check). Recorded on [Coverage](coverage.md). Do not treat J1–J8 as J9 or as a public-host probe. |
