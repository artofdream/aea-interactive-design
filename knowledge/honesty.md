...
| App tunnel tonight | **Unknown** until GET **200** this session. Old `https://nine-teams-try.loca.lt/` GET **503** (2026-09-04). Until that probe: Knowledge + clips. Not a permanent “no tunnel” claim. |
...
| **Local / tunnel** | Café Fausse App on `main` (Vite / Flask / `cafe-pg`). **Until a probed tunnel URL this session:** Knowledge + clips. Owner plans tunnel 10–15 min before 19:00 CET — write the live URL only after GET **200**. Silent clips are a **look**. | Not proof that a public restaurant host works. Not `cafe.artof.link`. |
