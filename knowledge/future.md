...
Meeting prep that **is** now on the thin map (once this ships): [Brief](brief.md) (Wed 2026-09-02 19:00 CET; owner locked 1, 3, 4) and [Coverage](coverage.md) (FR-1..FR-18 / NFR-1..NFR-9). Those pages are knowledge, not extra restaurant features.
