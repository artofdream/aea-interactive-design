...
4. **P0 live-proof path**
   ...
   - Tunnel if the room cannot see localhost — only after a GET this session. The loca.lt URL from 2026-09-02 timed out. App: Docker Engine still coming; do **not** claim tunnel or Flask is live.
