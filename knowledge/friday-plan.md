...
| [#57](https://github.com/artofdream/aea-interactive-design/issues/57) | Lightsail staging kept until owner decision. Monday **2026-09-08 16:00 Europe/Berlin** evaluate-only (not auto tear-down). Whether graders need the host for video evaluation remains **Unknown** until the owner shares correspondence. |
