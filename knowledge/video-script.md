...
> **Saturday lock (#97):** the live submit cut is the five-part VIDEO (team IDs → **Meghna** demo → Variant B → Variant C → close) on [Saturday](meeting-saturday.md) and [Talk cuts](presentation.md). This page’s Zoom dry-run is still **PROTOTYPE** (Variant A). Voice-over is **TBD**. Final Quantic submit video is **Unknown** until live must-film **plus** voice.
