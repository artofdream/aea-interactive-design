...
| NFR-7 | Chrome, Firefox, Safari, Edge | Standard React SPA + CSS. Partial matrix: Vite-only `:5173` (cts-ai, 2026-09-02); owner/sponsor mobile UX this session (2026-09-05); App Chrome + Firefox on `https://cafe.artof.link/` this session (2026-09-05). | **Partial** — Chrome **PASS** (Café Fausse App handoff this session, 2026-09-05): Chrome **152.0.7977.83** on cts-ai desktop; five SRS routes **PASS** on `https://cafe.artof.link/` (`/`, `/menu`, `/gallery`, `/reservations`, `/about`); Chrome headless dump-dom. Firefox **PASS** (same App handoff): Firefox **155.0.1**; same five routes; Firefox headless screenshots. Reports `C:\Users\Public\cafe-nfr7-probe.json` / `.txt` on cts-ai (not in this repo). Safari **PASS** (owner/sponsor report, [#117](https://github.com/artofdream/aea-interactive-design/issues/117)): Safari on iPhone 16, restaurant App + Knowledge mobile fit. This is **mobile Safari**, not a desktop Safari probe. Edge **PASS** all routes with screenshots (Vite-only 2026-09-02). A36 mobile UX probe (owner/sponsor); browser engine **Unknown** until named. Not a four-browser claim. **NFR-1** / **NFR-2** stay **Unknown** ([#119](https://github.com/artofdream/aea-interactive-design/issues/119) is a separate ROG ADB note). [#44](https://github.com/artofdream/aea-interactive-design/issues/44) / [#117](https://github.com/artofdream/aea-interactive-design/issues/117) / [#120](https://github.com/artofdream/aea-interactive-design/issues/120). | Compatibility is an SRS NFR. Chrome + Firefox public-host PASS plus mobile Safari and Vite Edge is still not Chrome + Firefox + Safari + Edge on desktop. |
...
| Journey / NFR recording | this page; [#40](https://github.com/artofdream/aea-interactive-design/issues/40) / [#44](https://github.com/artofdream/aea-interactive-design/issues/44) / [#117](https://github.com/artofdream/aea-interactive-design/issues/117) / [#120](https://github.com/artofdream/aea-interactive-design/issues/120) | App local UX / GET 2026-09-02 (cts-ai); J9 / NFR-3 / NFR-8 Vite slice **Vite-only**; `probe-nfr/` PNGs on cts-ai (not in this repo); owner/sponsor mobile UX this session (2026-09-05) on public hosts; App Chrome **152.0.7977.83** + Firefox **155.0.1** five-route **PASS** on `https://cafe.artof.link/` (dump-dom / screenshots; reports on cts-ai, not in repo); Knowledge GET of the 2026-09-02 tunnel timed out | J1–J8 PASS while DB was up; J9 / NFR-3 / NFR-8 PASS (Vite-only Edge screenshots + theme.css) plus public-host mobile note (iPhone 16 Safari + A36 UX fit). NFR-7 **partial** (Chrome + Firefox **PASS** on `cafe.artof.link`; Safari **PASS** on iPhone 16; Edge all routes on Vite; desktop Safari not probed; A36 browser engine Unknown). NFR-1 / NFR-2 not claimed met. Tunnel is not the live share; `cafe.artof.link` is. |
