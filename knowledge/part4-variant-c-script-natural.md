...
**Speaking rule:** Spoken / VO = clear, natural demo language — lead with **why**, then **how**. **No FR-/NFR- IDs, issue numbers, SHA, or CI job names on camera.** Demo focus: **cafe.artof.link** as MSAIE staging (temporary — not production forever). Mapping: [Parts 3–5 handoff mapping](parts-345-handoff-mapping.md).
